...
if(!empty($_POST['userid']) && !empty($_POST['idcomentario']) && !empty($_POST['comentarios'])){
    ...
    block_savingsbank_send_notification_cancelacion($_POST['idcomentario']);
    
      echo 'Se cancelo el formato';
